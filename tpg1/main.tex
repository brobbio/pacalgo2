...
\begin{tad}{\tadNombre{Pacalgo2}}
    ...
    \tadIgualdadObservacional{p_1}{p_2}{pacalgo2}{verMapa($p_1$)$\igobs$verMapa($p_2$)$\ \wedge$\\ trayectoria($p_1$)$\igobs$trayectoria($p_2$)\ $\wedge$ \\
        chocolatesRestantes($p_1$)$\igobs$ \\
        chocolatesRestantes($p_2$)}
...
\tadAxiomas
\tadAlinearAxiomas{chocolatesRestantes(izquierda($p$))}
    \tadAxioma{verMapa(inicializarJuego($m$)}{$m$}
    \tadAxioma{verMapa(arriba($p$))}{verMapa($p$)}
    \tadAxioma{verMapa(abajo($p$))}{verMapa($p$)}
    \tadAxioma{verMapa(izquierda($p$))}{verMapa($p$)}
    ...
    \tadAxioma{chocolatesRestantes(arriba($p$))}{\IF (posiciónActual($p$) + $\langle 0,1\rangle$) $\in$ chocolatesRestantes($p$) THEN chocolatesRestantes($p$) - \{ (posiciónActual($p$) + $\langle 0,1\rangle$) \} ELSE chocolatesRestantesEnElMapa($p$) FI}
    \tadAxioma{chocolatesRestantes(abajo($p$))}{\IF (posiciónActual($p$) - $\langle 0,1\rangle$) $\in$ chocolatesRestantes($p$) THEN chocolatesRestantes($p$) - \{ (posiciónActual($p$) - $\langle 0,1\rangle$) \} ELSE chocolatesRestantesEnElMapa($p$) FI}
    \tadAxioma{chocolatesRestantes(izquierda($p$))}{\IF (posiciónActual($p$) - $\langle 1,0\rangle$) $\in$ chocolatesRestantes($p$) THEN chocolatesRestantes($p$) - \{ (posiciónActual($p$) - $\langle 1,0\rangle$) \} ELSE chocolatesRestantesEnElMapa($p$) FI}
    \tadAxioma{chocolatesRestantes(derecha($p$))}{\IF (posiciónActual($p$) + $\langle 1,0\rangle$) $\in$ chocolatesRestantes($p$) THEN chocolatesRestantes($p$) - \{ (posiciónActual($p$) + $\langle 1,0\rangle$) \} ELSE chocolatesRestantesEnElMapa($p$) FI}
    \tadAxioma{perdió?($p$)}{ $\emptyset$?(conjFantasmas(verMapa($p$)) $\cap$ aDistanciaMenosDeN(posicionActual($p$), 3)) $\wedge$ 0?(nivelDeChocolate($p$)) }
    \tadAxioma{ganó?($p$)}{posiciónActual($p$)=casilleroDeLlegada(verMapa($p$))}
    \tadAxioma{posiciónActual($p$)}{prim(trayectoria($p$))}
